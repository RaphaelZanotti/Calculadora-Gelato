...
function calcular() {
  ...
  // =======================
  // 1️⃣ DILUIÇÃO INICIAL COM LEITE
  // =======================
  let leite = 0;
  ...
  // =======================
  // 2️⃣ AJUSTE DE PROTEÍNA → LEITE EM PÓ
  // =======================
  let leiteEmPo = 0;
  ...
  // =======================
  // 6️⃣ AJUSTE DE SÓLIDOS → MALTODEXTRINA
  // =======================
  let maltodextrina =
